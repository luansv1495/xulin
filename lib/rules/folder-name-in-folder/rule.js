...
var FolderNameInFolderRule = /** @class */ (function (_super) {
    ...
    function FolderNameInFolderRule(props) {
        var _this = _super.call(this, props) || this;
        _this.expectedFields = Object.values(model_1.FolderNameInFolderProps);
        _this.validations = [
        ...
        _this.getInvalidFolderInFolder = function (foldersInFolder) {
            var invalidFolders = foldersInFolder.filter(function (folder) { return !_this.rule.names.includes(folder); });
            return invalidFolders;
        };
        _this.getValidFolderInFolder = function (foldersInFolder) {
            var validFolders = foldersInFolder.filter(function (folder) {
                return _this.rule.names.includes(folder);
            });
            return validFolders;
        };
        return _this;
    }
    FolderNameInFolderRule.prototype.makeVerifyMessage = function () {
        this.verifyMessage = "Folder in ".concat((0, kleur_1.grey)(this.rule.folder), " should must contain one of the names ").concat((0, kleur_1.grey)(this.rule.names.join(',')), ".");
    };
    FolderNameInFolderRule.prototype.customVerify = function () {
        return __awaiter(this, void 0, void 0, function () {
            var foldersInFolder, validFolders, invalidFolders;
            var _this = this;
            return __generator(this, function (_a) {
                foldersInFolder = utils_1.FileSystem.getFoldersInFolder(this.rootDir, this.rule.folder);
                validFolders = this.getValidFolderInFolder(foldersInFolder);
                invalidFolders = this.getInvalidFolderInFolder(foldersInFolder);
