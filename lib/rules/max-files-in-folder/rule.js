...
var MaxFilesInFolderRule = /** @class */ (function (_super) {
    ...
    function MaxFilesInFolderRule(rule) {
        ...
        if (rule.quantity != undefined) {
            _this.verifyMessage = "Folder ".concat((0, kleur_1.grey)(rule.folder), " should contain ").concat((0, kleur_1.grey)(rule.quantity), " files.");
        }
        return _this;
    }
    MaxFilesInFolderRule.prototype.customVerify = function (rootDir) {
