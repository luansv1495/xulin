...
exports.MaxFilesInFolderRule = void 0;
...
var MaxFilesInFolderRule = /** @class */ (function (_super) {
    __extends(MaxFilesInFolderRule, _super);
    function MaxFilesInFolderRule(props) {
        var _this = _super.call(this, props) || this;
        _this.expectedFields = Object.values(model_1.MaxFilesInFolderProps);
        _this.validations = [
    ...
    MaxFilesInFolderRule.prototype.makeVerifyMessage = function () {
        this.verifyMessage = "Folder ".concat((0, kleur_1.grey)(this.rule.folder), " should contain ").concat((0, kleur_1.grey)(this.rule.quantity), " files.");
    };
    MaxFilesInFolderRule.prototype.customVerify = function () {
        return __awaiter(this, void 0, void 0, function () {
            var filesInFolder;
            return __generator(this, function (_a) {
                filesInFolder = utils_1.FileSystem.getFilesInFolder(this.rootDir, this.rule.folder);
    ...
    return MaxFilesInFolderRule;
}(base_rule_1.BaseRule));
exports.MaxFilesInFolderRule = MaxFilesInFolderRule;
