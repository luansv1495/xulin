...
var FolderNameSizeInFolderRule = /** @class */ (function (_super) {
    ...
    function FolderNameSizeInFolderRule(props) {
        var _this = _super.call(this, props) || this;
        _this.expectedFields = Object.values(model_1.FolderNameSizeInFolderProps);
        _this.validations = [
    ...
    FolderNameSizeInFolderRule.prototype.makeVerifyMessage = function () {
        this.verifyMessage = "Folders names must contain a minimum of ".concat((0, kleur_1.grey)(this.rule.min), " characters and a maximum of ").concat((0, kleur_1.grey)(this.rule.max), " characters in ").concat((0, kleur_1.grey)(this.rule.folder), " folder.");
    };
    FolderNameSizeInFolderRule.prototype.customVerify = function () {
        return __awaiter(this, void 0, void 0, function () {
            var foldersInFolder, validFolders, invalidFolders;
            var _this = this;
            return __generator(this, function (_a) {
                foldersInFolder = utils_1.FileSystem.getDeepFoldersInFolder(this.rootDir, this.rule.folder, []);
                validFolders = this.getValidFolders(foldersInFolder);
                invalidFolders = this.getInvalidFolders(foldersInFolder, validFolders);
