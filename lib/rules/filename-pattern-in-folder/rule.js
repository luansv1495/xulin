...
var FilenamePatternInFolderRule = /** @class */ (function (_super) {
    ...
    function FilenamePatternInFolderRule(props) {
        var _this = _super.call(this, props) || this;
        _this.expectedFields = Object.values(model_1.FilenamePatternInFolderProps);
        _this.validations = [
        ...
        _this.getInvalidFilesInFolder = function (filesInFolder, validFilesInFolder) {
            var invalidFiles = filesInFolder.filter(function (fileInFolder) { return !validFilesInFolder.includes(fileInFolder); });
            return invalidFiles;
        };
        return _this;
    }
    FilenamePatternInFolderRule.prototype.makeVerifyMessage = function () {
        this.verifyMessage = "Files in ".concat((0, kleur_1.grey)(this.rule.folder), " should contains ").concat((0, kleur_1.grey)(this.rule.patterns.join(',')), ".");
    };
    FilenamePatternInFolderRule.prototype.customVerify = function () {
        return __awaiter(this, void 0, void 0, function () {
            var filesInFolder, validFilesInFolder, invalidFilesInFolder;
            var _this = this;
            return __generator(this, function (_a) {
                filesInFolder = utils_1.FileSystem.getDeepFilesInFolder(this.rootDir, this.rule.folder, []);
                validFilesInFolder = utils_1.FileSystem.getFilesByPatternInFolder(this.rootDir, this.rule.folder, this.rule.patterns);
                invalidFilesInFolder = this.getInvalidFilesInFolder(filesInFolder, validFilesInFolder);
