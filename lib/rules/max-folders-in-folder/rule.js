...
var MaxFoldersInFolderRule = /** @class */ (function (_super) {
    ...
    function MaxFoldersInFolderRule(props) {
        var _this = _super.call(this, props) || this;
        _this.expectedFields = Object.values(model_1.MaxFoldersInFolderProps);
        _this.validations = [
    ...
    MaxFoldersInFolderRule.prototype.makeVerifyMessage = function () {
        this.verifyMessage = "Folder ".concat((0, kleur_1.grey)(this.rule.folder), " should contain ").concat((0, kleur_1.grey)(this.rule.quantity), " folders.");
    };
    MaxFoldersInFolderRule.prototype.customVerify = function () {
