...
var filename_size_1 = require("./filename-size");
    ...
    function RuleFactory(rule, rootDir) {
        ...
        this.validate = function () {
            ...
            if (_this.rule.name === rule_model_1.RuleNameEnum.filenamePatternInFolder) {
                ...
                new max_folders_in_folder_1.MaxFoldersInFolderRule(_this.rule).validate({
                    rule: _this.rule,
                    rootDir: _this.rootDir,
                    expectedFields: Object.values(max_folders_in_folder_1.MaxFoldersInFolderProps).concat(Object.values(rule_model_1.RuleProps))
                });
            }
            else if (_this.rule.name === rule_model_1.RuleNameEnum.filenameSizeInFolder) {
                new filename_size_1.FilenameSizeInFolderRule(_this.rule).validate({
                    rule: _this.rule,
                    rootDir: _this.rootDir,
                    expectedFields: Object.values(filename_size_1.FilenameSizeInFolderProps).concat(Object.values(rule_model_1.RuleProps))
                });
            }
        };
        this.verify = function () {
            ...
            if (_this.rule.name === rule_model_1.RuleNameEnum.filenamePatternInFolder) {
                ...
                state = new filename_size_1.FilenameSizeInFolderRule(_this.rule).verify(_this.rootDir);
            }
            return state;
        };
    }
