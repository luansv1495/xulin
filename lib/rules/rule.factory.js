    ...
    function RuleFactory(rule, rootDir) {
        ...
        this.validate = function () {
            ...
            if (_this.rule.name === rule_model_1.RuleNameEnum.filenamePatternInFolder) {
                ...
                new folder_name_size_in_folder_1.FolderNameSizeInFolderRule(_this.rule).validate({
                    rule: rest,
                    rootDir: _this.rootDir,
                    expectedFields: Object.values(folder_name_size_in_folder_1.FolderNameSizeInFolderProps)
                });
            }
        };
        this.verify = function () {
            ...
            if (_this.rule.name === rule_model_1.RuleNameEnum.filenamePatternInFolder) {
                ...
                state = new folder_name_size_in_folder_1.FolderNameSizeInFolderRule(_this.rule).verify(_this.rootDir);
            }
            return state;
        };
    }
