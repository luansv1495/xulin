...
var PatternsIsInvalidInRuleError = /** @class */ (function (_super) {
    ...
    function PatternsIsInvalidInRuleError(result, ruleName) {
        /* istanbul ignore next */
        return _super.call(this, "Field patterns with value ".concat(result, " In ").concat(ruleName, " rule.")) || this;
    }
...
var FolderNameIsInvalidInRuleError = /** @class */ (function (_super) {
    ...
    function FolderNameIsInvalidInRuleError(result, ruleName) {
        /* istanbul ignore next */
        return _super.call(this, "Field names with value ".concat(result, " In ").concat(ruleName, " rule.")) || this;
    }
...
var MaxMinIsInvalidInRuleError = /** @class */ (function (_super) {
    __extends(MaxMinIsInvalidInRuleError, _super);
    function MaxMinIsInvalidInRuleError(result, ruleName, fieldName) {
        /* istanbul ignore next */
        return _super.call(this, "Field ".concat(fieldName, " with value ").concat(result, " In ").concat(ruleName, " rule.")) || this;
    }
    return MaxMinIsInvalidInRuleError;
}(RuleError));
exports.MaxMinIsInvalidInRuleError = MaxMinIsInvalidInRuleError;
var FilenameSizeInRuleError = /** @class */ (function (_super) {
    __extends(FilenameSizeInRuleError, _super);
    function FilenameSizeInRuleError(fileName, ruleName) {
        /* istanbul ignore next */
        return _super.call(this, "".concat((0, kleur_1.grey)(ruleName), ": Filename ").concat((0, kleur_1.grey)(fileName), " not match.")) || this;
    }
    return FilenameSizeInRuleError;
}(RuleError));
exports.FilenameSizeInRuleError = FilenameSizeInRuleError;
var FolderNameSizeInRuleError = /** @class */ (function (_super) {
    __extends(FolderNameSizeInRuleError, _super);
    function FolderNameSizeInRuleError(fileName, ruleName) {
        /* istanbul ignore next */
        return _super.call(this, "".concat((0, kleur_1.grey)(ruleName), ": Folder name ").concat((0, kleur_1.grey)(fileName), " not match.")) || this;
    }
    return FolderNameSizeInRuleError;
}(RuleError));
exports.FolderNameSizeInRuleError = FolderNameSizeInRuleError;
var FolderInListIsInvalidInRuleError = /** @class */ (function (_super) {
    __extends(FolderInListIsInvalidInRuleError, _super);
    function FolderInListIsInvalidInRuleError(result, ruleName) {
        /* istanbul ignore next */
        return _super.call(this, "Field folders with value ".concat(result, " In ").concat(ruleName, " rule.")) || this;
    }
    return FolderInListIsInvalidInRuleError;
}(RuleError));
exports.FolderInListIsInvalidInRuleError = FolderInListIsInvalidInRuleError;
var FolderInListIsEqualToTargetFolderInRuleError = /** @class */ (function (_super) {
    __extends(FolderInListIsEqualToTargetFolderInRuleError, _super);
    function FolderInListIsEqualToTargetFolderInRuleError(result, ruleName) {
        /* istanbul ignore next */
        return _super.call(this, "Field folders with value ".concat(result, " In ").concat(ruleName, " rule.")) || this;
    }
    return FolderInListIsEqualToTargetFolderInRuleError;
}(RuleError));
exports.FolderInListIsEqualToTargetFolderInRuleError = FolderInListIsEqualToTargetFolderInRuleError;
var FileContainsInvalidDependenciesInRuleError = /** @class */ (function (_super) {
    __extends(FileContainsInvalidDependenciesInRuleError, _super);
    function FileContainsInvalidDependenciesInRuleError(targetFile, invalidDependence, ruleName) {
        /* istanbul ignore next */
        return _super.call(this, "".concat((0, kleur_1.grey)(ruleName), ": File ").concat((0, kleur_1.grey)(targetFile), " contains dependencies of ").concat(invalidDependence, ".")) || this;
    }
    return FileContainsInvalidDependenciesInRuleError;
}(RuleError));
exports.FileContainsInvalidDependenciesInRuleError = FileContainsInvalidDependenciesInRuleError;
